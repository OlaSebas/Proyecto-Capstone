  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-blue-50 to-green-50">
      ...
      <main className="flex-1 flex flex-col p-4 md:p-6 items-center">
          ...
          {tab === "agregar" && (
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <input
                ...
                className="border rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-red-400 outline-none"
              />
              <input
                type="number"
                value={precio}
        ...
        {modalEditar.abierto && (
          <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg w-80 flex flex-col gap-3">
