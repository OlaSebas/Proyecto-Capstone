...
from .views import login, register, profile, logout,sesiones_detail, sesiones_list, cargarSesionActiva, users,sesiones_create,venta,ventas_list
...
urlpatterns = [
    ...
    path('sesion_create/', sesiones_create, name='sesiones_create'),
    ...
    path('venta_list/',ventas_list, name='venta_list'),
]